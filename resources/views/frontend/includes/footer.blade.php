<footer class="footer">
  ...
  <div class="footer-bottom">
    ...
    <div class="payment">
      ...
      <div class="list">
        <a href="#" class="item"><img src="{{asset('butik/images/payments/1.png')}}" alt=""></a>
        <a href="#" class="item"><img src="{{asset('butik/images/payments/2.png')}}" alt=""></a>
        <a href="#" class="item"><img src="{{asset('butik/images/payments/3.png')}}" alt=""></a>
        <a href="#" class="item"><img src="{{asset('butik/images/payments/4.png')}}" alt=""></a>
      </div>
    </div>
    </div>
  </div>

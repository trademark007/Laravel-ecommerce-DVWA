...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	  <div> <a href="#"><img src="{{asset('images/items/15.jpg')}}"></a></div>
	</div> <!-- slider-product.// -->
	<div class="thumbs-wrap">
	  <a href="#" class="item-thumb"> <img src="{{asset('images/items/15.jpg')}}"></a>
	  <a href="#" class="item-thumb"> <img src="{{asset('images/items/15-1.jpg')}}"></a>
	  <a href="#" class="item-thumb"> <img src="{{asset('images/items/15-2.jpg')}}"></a>
	  <a href="#" class="item-thumb"> <img src="{{asset('images/items/15-1.jpg')}}"></a>
	</div> <!-- slider-nav.// -->
...
<div class="mb-3"> 
	<var class="price h4">@money($product->price)</var> 
